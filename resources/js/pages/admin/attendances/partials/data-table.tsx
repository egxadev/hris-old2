...
const ActionCell = ({ data, isTrashed = false }: { data: Attendance; isTrashed?: boolean }) => {
    ...
    function handleRestore() {
        router.patch(
            route('admin.attendances.restore', data.id),
            {},
            {
                preserveState: false,
                preserveScroll: true,
                ...
                onError: () => {
                    setIsDropdownOpen(false);
                    console.error('Failed to restore attendance.');
                },
            },
        );
    }
    ...
    function handleForceDelete() {
        router.delete(route('admin.attendances.force-delete', data.id), {
            preserveState: false,
            preserveScroll: true,
            onSuccess: () => {
                setIsDropdownOpen(false);
                console.log('Attendance permanently deleted successfully.');
            },
            onError: () => {
                setIsDropdownOpen(false);
                console.error('Failed to permanently delete attendance.');
            },
        });
    }
