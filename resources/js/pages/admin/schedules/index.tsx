        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="w-full p-4">
                <div className="mx-auto space-y-6">
                    <Heading title="Schedule" description="Manage employee schedules" />
                    ...
                    <div className="flex items-center py-4">
                        ...
                        <div className="ml-auto flex flex-row gap-1">
                            ...
                            <Link className="" href={route('admin.schedules.create')}>
                                        ...
                                        <>
                                            ...
                                            {meta.current_page > 2 && (
                                                <PaginationItem>
                                                    <PaginationLink
                                                        href="#"
                                                        onClick={() => handleServerOperation({ page: meta.current_page - 1 })}
                                                    >
                                                        {meta.current_page - 1}
                                                    </PaginationLink>
                                                </PaginationItem>
                                            )}
                                            {meta.current_page !== 1 && meta.current_page !== meta.last_page && (
                                                <PaginationItem>
                                        ...
                                        [...Array(meta.last_page)].map((_, i) => (
                                            <PaginationItem key={i}>
                                                <PaginationLink
                                                    ...
                                                    onClick={() => handleServerOperation({ page: i + 1 })}
                                                >
                                                    {i + 1}
                                                </PaginationLink>
                                            </PaginationItem>
